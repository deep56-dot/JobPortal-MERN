...
export const fetchAllJobs= (city,niche,searchKeyword="")=> async (dispatch)=>{
    try {
        ...
        let link = "https://jobportal-backend-vm5e.onrender.com/api/v1/job/getall?"
        let queryParams= []
        if(searchKeyword){
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://jobportal-backend-vm5e.onrender.com/api/v1/job/get/${jobId}`,
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://jobportal-backend-vm5e.onrender.com/api/v1/job/post`,
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://jobportal-backend-vm5e.onrender.com/api/v1/job/getmyjobs`,
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://jobportal-backend-vm5e.onrender.com/api/v1/job/delete/${id}`,
      { withCredentials: true }
    );
